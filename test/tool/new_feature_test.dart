...
void main() {
  test('new_feature.dart scaffolds a feature-first module', () async {
    ...
    final expected = [
      ...
      p.join(base, 'data', 'datasource', 'demo_widget_remote_datasource.dart'),
      p.join(base, 'data', 'repositories', 'demo_widget_repository_impl.dart'),
      p.join(base, 'presentation', 'providers', 'demo_widget_providers.dart'),
      p.join(base, 'presentation', 'providers', 'state', 'demo_widget_state.dart'),
      p.join(base, 'presentation', 'providers', 'state', 'demo_widget_notifier.dart'),
      p.join(base, 'presentation', 'screens', 'demo_widget_screen.dart'),
      p.join(root, 'test', 'features', 'demo_widget', 'data', 'repositories',
          'demo_widget_repository_impl_test.dart'),
      p.join(root, 'test', 'features', 'demo_widget', 'presentation',
          'providers', 'demo_widget_notifier_test.dart'),
    ];
    ...
    final libFeature = Directory(p.join(root, 'lib', 'features', 'demo_widget'));
    if (libFeature.existsSync()) await libFeature.delete(recursive: true);
    final testFeature =
        Directory(p.join(root, 'test', 'features', 'demo_widget'));
