...
void main() {
  ...
  group('ExceptionHandler Mixin Test\n', () {
    test('handle exception returns Response on success', () async {
    ...
    test('handle exception returns AppException on error', () async {
      when(() => mockDioNetworkServide.dio.get(any())).thenThrow(Exception());
      final resp = await mockDioNetworkServide.get('');
    ...
    test(
      ...
      () async {
        when(
          () => mockDioNetworkServide.dio.get(any()),
    ...
    test('handle exception handles DioException with statusCode 1', () async {
      when(
        () => mockDioNetworkServide.dio.get(any()),
